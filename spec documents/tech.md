...
- **Layout guards for galleries**: Gallery cards flip to a two-column grid (`text | media`) whenever space permits and fall back to a single column on narrower screens to keep the layout legible.
